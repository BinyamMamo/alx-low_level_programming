...
* [File descriptors](http://www/rltoken/Duva-9Fjyskt39R__Nnazg)
* [C Programming in Linux Tutorial #024 - open() read() write() Functions](http://www/rltoken/x05veqiLPSxXmJf9zTtCkQ)
...
At the end of this project, you are expected to be able to [explain to anyone](http://www/rltoken/kQg2-u-cAYxh6oJz2TWHWw), without the help of Google:
